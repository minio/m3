...
type PolicyInfoHandlerFunc func(PolicyInfoParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PolicyInfoHandlerFunc) Handle(params PolicyInfoParams) middleware.Responder {
	return fn(params)
}

// PolicyInfoHandler interface for that can handle valid policy info params
type PolicyInfoHandler interface {
	Handle(PolicyInfoParams) middleware.Responder
}
