...
type SetConfigHandlerFunc func(SetConfigParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SetConfigHandlerFunc) Handle(params SetConfigParams) middleware.Responder {
	return fn(params)
}

// SetConfigHandler interface for that can handle valid set config params
type SetConfigHandler interface {
	Handle(SetConfigParams) middleware.Responder
}
