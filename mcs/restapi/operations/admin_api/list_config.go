...
type ListConfigHandlerFunc func(ListConfigParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ListConfigHandlerFunc) Handle(params ListConfigParams) middleware.Responder {
	return fn(params)
}

// ListConfigHandler interface for that can handle valid list config params
type ListConfigHandler interface {
	Handle(ListConfigParams) middleware.Responder
}
