...
type UpdateServiceAccountParams struct {
	...
	/*
	  ...
	  In: body
	*/
	Body *models.M3UpdateServiceAccountRequest
	/*
	  Required: true
	  In: path
	*/
...
func (o *UpdateServiceAccountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.M3UpdateServiceAccountRequest
...
func (o *UpdateServiceAccountParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
