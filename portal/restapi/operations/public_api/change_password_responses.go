...
/*ChangePasswordOK A successful response.
...
func (o *ChangePasswordOK) WithPayload(payload models.M3Empty) *ChangePasswordOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the change password o k response
func (o *ChangePasswordOK) SetPayload(payload models.M3Empty) {
	o.Payload = payload
}
