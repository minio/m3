...
const (
	InviteAction_ADD   InviteAction = 0
	InviteAction_RESET InviteAction = 1
)
...
type UserInviteRequest struct {
	...
	Email                string       `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`
	Action               InviteAction `protobuf:"varint,3,opt,name=action,proto3,enum=m3.InviteAction" json:"action,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *UserInviteRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UserInviteRequest.Unmarshal(m, b)
}
...
func (m *UserInviteRequest) XXX_Size() int {
	return xxx_messageInfo_UserInviteRequest.Size(m)
}
...
func (m *UserInviteRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *UserInviteRequest) GetAction() InviteAction {
	if m != nil {
		return m.Action
	}
	return InviteAction_ADD
}
...
func init() {
	proto.RegisterEnum("m3.InviteAction", InviteAction_name, InviteAction_value)
	...
	proto.RegisterType((*UserInviteRequest)(nil), "m3.UserInviteRequest")
...
var fileDescriptor_e027d33627c05e07 = []byte{
	...
	,
}
...
type PublicAPIClient interface {
	...
	// UserInvite sends an email invitation for sign up
	UserInvite(ctx context.Context, in *UserInviteRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *publicAPIClient) UserInvite(ctx context.Context, in *UserInviteRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/m3.PublicAPI/UserInvite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PublicAPIServer interface {
	...
	// UserInvite sends an email invitation for sign up
	UserInvite(context.Context, *UserInviteRequest) (*Empty, error)
	// ValidateInvite validates url token sent for resetting password or sign Up
...
func (*UnimplementedPublicAPIServer) UserInvite(ctx context.Context, req *UserInviteRequest) (*Empty, error) {
...
func _PublicAPI_UserInvite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInviteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PublicAPIServer).UserInvite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m3.PublicAPI/UserInvite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicAPIServer).UserInvite(ctx, req.(*UserInviteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PublicAPI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PublicAPI_UserInvite_Handler,
		},
		{
