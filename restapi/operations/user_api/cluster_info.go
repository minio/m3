...
type ClusterInfoHandlerFunc func(ClusterInfoParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn ClusterInfoHandlerFunc) Handle(params ClusterInfoParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// ClusterInfoHandler interface for that can handle valid cluster info params
type ClusterInfoHandler interface {
	Handle(ClusterInfoParams, *models.Principal) middleware.Responder
}
...
/*ClusterInfo swagger:route GET /clusters/{name} UserAPI clusterInfo
