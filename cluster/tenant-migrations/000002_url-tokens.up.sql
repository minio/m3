...
create table provisioning.url_tokens
(
    id          uuid
...
comment on table provisioning.url_tokens is 'Holds tokens and their validity for multifple functions such as password reset or tenant invite';

comment on column provisioning.url_tokens.user_id is 'User this token is associated with';
